...
// void PrintVisitor::visit(std::shared_ptr<PrintStatement> n)
// {
//     std::cout << "Visiting Print Statement" << std::endl;
// }

void PrintVisitor::visit(std::shared_ptr<AssignStatement> n)
{
    std::cout << "Visiting Assign Statement" << std::endl;
}

void PrintVisitor::visit(std::shared_ptr<ArrayAssignStatement> n)
{
    std::cout << "Visiting ArrayAssign Statement" << std::endl;
}