...
%token ESCAPE ASCII
%token INT BOOLEAN CHAR BYTE SHORT	
%token OR_OR AND_AND OR XOR AND EQUAL NOT_EQUAL LESS GREATER LESS_EQUAL GREATER_EQUAL 
%token INSTANCEOF
%token LEFT_SHIFT RIGHT_SHIFT UNSIGNED_RIGHT_SHIFT PLUS MINUS STAR DIVIDE MODULO
%token LEFT_PAREN RIGHT_PAREN COLON QUESTION_MARK APOSTROPHE QUOTE
...
%token IMPORT PACKAGE INTERFACE RETURN VOID NEW THIS NULL
%%
