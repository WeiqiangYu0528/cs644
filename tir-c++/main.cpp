...
int main() {
    ...
    //         return x + 20 * 5;
    //     }
    std::string arg0 = std::to_string(Configuration::ABSTRACT_ARG_PREFIX) + "0";
    std::string arg1 = std::to_string(Configuration::ABSTRACT_ARG_PREFIX) + "1";
    ...
    auto aBody = std::make_shared<Seq>(std::vector<std::shared_ptr<Stmt>>{
        ...
        std::make_shared<Return>(std::make_shared<BinOp>(OpType::ADD,
            std::make_shared<Temp>("i"),
            std::make_shared<BinOp>(OpType::MUL,
    ...
    auto bBody = std::make_shared<Seq>(std::vector<std::shared_ptr<Stmt>>{
        ...
        std::make_shared<Move>(std::make_shared<Temp>("x"),
            std::make_shared<BinOp>(OpType::ADD,
